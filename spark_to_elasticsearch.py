...
checkpointDir = "file:///Users/muditjoshi/Desktop/StreamingData/checkpoints"  # Adjusted this path.
...
def create_spark_session():
    """
    This function initializes a Spark session with specific configurations:
    """
...
def create_elasticsearch_connection():
    ...
    try:
        ...
        logging.info(f"Connection {es} created successfully")
    except Exception as e:
        traceback.print_exc(file=sys.stderr)
